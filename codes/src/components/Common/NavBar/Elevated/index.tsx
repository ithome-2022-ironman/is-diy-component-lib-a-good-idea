...
function NavBarElevatedDemo(): React.ReactElement {
  /* States */
  ...
  return (
    <React.Fragment>
      <Container
        classes={{ wrapper: cn(navWrapper, percentage && navWrapperBgColor) }}
        renderAs="nav"
      >
...
export default memo(NavBarElevatedDemo);
